...
import blogLogo from "../asset/image/icons8-blog-64 (1).png";
import Home from "../asset/image/icons8-home-64.png";
import about from "../asset/image/icons8-about-64.png";
...
function Navbar() {
  ...
  return (
    <>
      {/* <div
        className={`fixed  ${
          isShownav ? "top-0 right-0" : "-top-[800px] "
        ...
        <nav className="font-vazir text-md text-gray-600 dark:text-gray-200 font-semibold transition-all delay-300 ">
          <ul
            ...
            onClick={showHandler}>
            <li className="hover:text-purple-600 flex items-center gap-x-1">
            ...
            <li className="hover:text-purple-600  flex items-center gap-x-1">
              <img src={blogLogo} alt="" className="w-6" />
        ...
        <div className=" items-center justify-start gap-y-2  mt-4 mb-4 flex">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <header className="w-full m-auto flex items-center justify-between px-4 py-2 border border-gray-500 rounded-lg mt-3">
        <Link to="/" className="logo flex items-center">
          <p className="font-lale text-xl dark:text-gray-200">بلاگ</p>
          <img src={logo} className="w-10 h-10" />
        </Link>
